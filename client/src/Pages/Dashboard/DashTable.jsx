...
// function DashTable({userData}) {
//     const [userList,setUserList]=useState([])
//     const [totalUser,setTotalUser]=useState(0)
//     const [isViewAllActive,setIsViewAllActive]=useState(true)
//     const [isAllUserActive,setIsAllUserActive]=useState(true)
//     const [isAdminActive,setIsAdminActive]=useState(true)
//     const [isSuperAdminActive,setIsSuperAdminActive]=useState(true)
//     const [isManagerActive,setIsManagerAdminActive]=useState(true)
...
//        <button  className='border-2 border-gray-400 px-4 py-1'>Adamin</button>
